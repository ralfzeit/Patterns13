...
namespace kursovaya
{
    public partial class MainForm_user : Form
    {
        ...
        public MainForm_user(string str1, string str2)
        {
            PLogin = str1;
            PPass = str2;
            InitializeComponent();
        ...
        private void MainForm_user_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Visible = false;
            this.oi.ShowDialog();
        }
        ...
        private void личныйКабинетToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            kabinet kab = new kabinet(PLogin);
            kab.ShowDialog();
        }
