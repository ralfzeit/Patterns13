...
namespace kursovaya
{
    public partial class MainForm_oper : Form
    {
        Form1 oi = new Form1();
        ...
        private void MainForm_oper_Load(object sender, EventArgs e)
        {
        ...
        private void MainForm_oper_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Visible = false;
            this.oi.ShowDialog();
        }
        ...
        {
            if (radioButton1.Checked == true)
                this.первыйЭтажToolStripMenuItem.Checked = true;
            else
                this.первыйЭтажToolStripMenuItem.Checked = false;
        ...
        private void первыйЭтажToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void изменитьДанныеОТекущейАрендеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            PictureBox ppb = (PictureBox)((ContextMenuStrip)((ToolStripMenuItem)sender).Owner).SourceControl;
        ...
        private void списокОператоровToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            oper obj = new oper();
            obj = operlist.FindCLassLogin(PLogin);
