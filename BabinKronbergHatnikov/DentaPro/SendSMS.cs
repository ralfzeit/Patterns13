...
namespace Denta_Pro
{
    public partial class SendSMS : Form
    {
       ...
       public int id;
       public string fio;
        public SendSMS(int ID, string FIO, DRIVER dob)
        {
            InitializeComponent();
            db = dob;
            id = ID;
             ...
             public class Sms : IDisposable
    {
        ...
        public void SendSms(string number, string text)
        {
            ...
            //Если номер преобразован верно
            if (string.IsNullOrEmpty(revNumber)) return;
            //Если строка нормально преобразована
            if (string.IsNullOrEmpty(revText)) return;
            //Формируем пакет sms
